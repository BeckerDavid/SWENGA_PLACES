...
<head>
    ...
    <link href="bootstrap/css/light-bootstrap-dashboard.css?v=2.0.0 " rel="stylesheet" />
            ...
            <div class="sidebar-wrapper"> 
                <div class="logo">
                    <a href="javascript:;" class="simple-text">
                      <img src="Resources/logo.png" width="250px" height="55px">
                    </a> 
                </div>
                <ul class="nav">
                ...
                <div class="container-fluid">
                    <nav>
                        ...
                        <p class="copyright text-center">
                            ...
                            <a href="http://www.creative-tim.com">Creative Ardian</a>, made with love for a better SWENGA project
                        </p>
                    </nav>
                </div>
            </footer>
        ...
        <ul class="dropdown-menu">
            ...
            <li class="active">
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                    <img src="bootstrap/img/sidebar-1.jpg" alt="" />
                </a>
            </li>
            <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                    <img src="bootstrap/img/sidebar-3.jpg" alt="" />
                </a>
            </li>
            <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                    <img src="/bootstrap/img/sidebar-4.jpg" alt="" />
                </a>
            </li>
            <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                    <img src="bootstrap/img/sidebar-5.jpg" alt="" />
                </a>
            </li>
...
<script src="bootstrap/js/core/bootstrap.min.js" type="text/javascript"></script>
