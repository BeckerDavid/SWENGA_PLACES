...
<link rel="apple-touch-icon" sizes="76x76"
	href="../bootstrap/img/apple-icon.png">
...
<body>
	<div class="wrapper">
		<div class="sidebar" data-image="../Resources/sidebarbg.jpg"
			data-color="blue">
			<!--
    ...
    -->
			<div class="sidebar-wrapper">
				<div class="logo">
					<a href="javascript:;" class="simple-text"> <img
						src="../Resources/logo.png" width="250px" height="55px">
					</a>
				</div>
				<ul class="nav">
					<li class="nav-item active"><a class="nav-link"
						href="../files/dashboard.jsp"> <i
							class="nc-icon nc-icon nc-paper-2"></i>
							<p>Dashboard</p>
					</a></li>
					<li><a class="nav-link" href="../files/browse.jsp"> <i
							class="nc-icon nc-tablet-2"></i>
							<p>Browse</p>
					</a></li>
					<li><a class="nav-link" href="../files/journey.jsp"> <i
							class="nc-icon nc-map-big"></i>
							<p>Journey</p>
					</a></li>
					<li><a class="nav-link" href="../files/following.jsp"> <i
							class="nc-icon nc-chart"></i>
							<p>Following</p>
					</a></li>

					<li><a class="nav-link" href="../files/achievements.jsp">
							<i class="nc-icon nc-pin-3"></i>
							<p>Achievements</p>
					</a></li>
					<li><a class="nav-link" href="../files/contracts.jsp"> <i
							class="nc-icon nc-chat-round"></i>
							<p>Contacts</p>
					</a></li>
					<li><a class="nav-link" href="../files/userProfile.jsp"> <i
							class="nc-icon nc-globe-2"></i>
							<p>Public Profile</p>
					</a></li>
					<li class="nav-item active active-pro"><a
						class="nav-link active" href="javascript:;"> <i
							class="nc-icon nc-chat-round"></i>
							<p>Test</p>
					</a></li>
				</ul>
					...
					<div class="collapse navbar-collapse justify-content-end"
						...
						<ul class="navbar-nav ml-auto">
							...
							<li class="nav-item"><a class="nav-link"
								href="../Resources/login.jsp"> <span class="no-icon">Log
										in</span>
							</a></li>
						</ul>
					</div>
...
<!--   Core JS Files   -->
<script src="../bootstrap/js/core/jquery.3.2.1.min.js"
	type="text/javascript"></script>
<script src="../bootstrap/js/core/popper.min.js" type="text/javascript"></script>
<script src="../bootstrap/js/core/bootstrap.min.js"
	type="text/javascript"></script>
